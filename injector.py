...
def injeect():
        ...
        if file_exists == False:
            ...
            print(f"{now} Cheat hopefully downloaded\n If its displaying an error, when injecting, open my code and open the downloading link from above!")
        else:
        ...
        try:
            ...
            print(f"{now} ___C.ERR. CS:GO didnt launch! wtf?")
